...
{
    /// <summary>
    /// ReplyPostUpload_json 的摘要说明
    /// 用于PostDetails页面
    /// </summary>
    public class ReplyPostUpload_json : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //6.定义文件名,保存图片
            //1,2
            string xiangDuiPath = "/Images/HuiTieImages/";
            string wuLiPath = context.Server.MapPath("~//Images/HuiTieImages/");
            //3.
